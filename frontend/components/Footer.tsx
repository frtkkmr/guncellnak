    ...
    <View style={styles.footer}>
      ...
      <View style={styles.footerContent}>
        ...
        <View style={styles.footerColumn}>
          ...
          <TouchableOpacity style={styles.contactItem} onPress={() => openURL('tel:+908505551234')}>
            <Ionicons name="call" size={16} color="#3498db" />
            <Text style={styles.contactText}>0850 555 12 34</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.contactItem} onPress={() => openURL('mailto:info@nakliyat.com')}>
